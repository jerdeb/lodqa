...
echo "Pulling Luzzu"
git clone https://github.com/EIS-Bonn/Luzzu.git -b experimental
...
rm -rf pom.xml
wget https://dl.dropboxusercontent.com/u/5895290/diachron/pom.xml
...
rm -rf log4j.xml
wget https://dl.dropboxusercontent.com/u/5895290/luzzu/log4j.xml
